...
<!-- For SEO -->
    ...
    <meta name="keywords" content=" SMS BOMBER + CALL BOMBER [2024]">
    <meta name="author" content="𝐆𝐎𝐔𝐑𝐀𝐕 𝐕𝐈𝐏 𝐁𝐎𝐌𝐁𝐄𝐑">    
    <!-- BOOTSTRAP CODE -->
  ...
  echo "<meta http-equiv='refresh' content='1'>";
    ...
    echo'<div class="form">
      <form action="" method="GET">
          ...
          <a style="background-color: red;" class="btn btn-primary fw-bold p-2" href="//telegram.me/+CRAZY_GOURAV" >Get key<i class="fa fa-telegram"></i>
          </a>
